...
After identifying the best-performing model among all the trained deep learning models, a simulation was conducted. Using the same parameters from the initial training, the selected model was retrained with the original dataset along with new data up to January 2025. The retrained model was then used to forecast dengue cases for the period from February 2025 to May 2025. Figure \ref{fig:lstm_model_testing_snippet} shows a code snippet of the model training.

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{lstm_model_testing_snippet}
	\caption{Testing Folds - Window Size 5}
	\label{fig:lstm_model_testing_snippet}
\end{figure}

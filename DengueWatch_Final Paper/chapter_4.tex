...
\begin{figure}[H]
	...
	\caption{User Identification when Signing Up}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth, height=0.6\textheight, keepaspectratio]{case_report_form_1}
	\caption{First Part of Case Report Form}
	\label{fig:case_report_form_1}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth, height=0.6\textheight, keepaspectratio]{case_report_form_2}
	\caption{Second Part of Case Report Form}
	\label{fig:case_report_form_2}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth, height=0.6\textheight, keepaspectratio]{bulk_upload}

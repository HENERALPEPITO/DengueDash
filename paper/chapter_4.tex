...
To identify outbreaks, we calculated the outbreak threshold value using statistical analysis of the dataset. The threshold is determined using the formula:  
...
This result indicates that when dengue cases exceed 98, an outbreak can be considered in Iloilo City.  
...
\begin{table}[h!]
	...
	\begin{tabular}{|l|c|c|c|}
		...
		\begin{tabular}[c]{@{}l@{}}\textbf{Seasonal ARIMA} \\ \textbf{(2, 0, 2) (0, 1,1)}\end{tabular} & \textbf{1109.69} & \textbf{33.31} & \textbf{0} \\ \hline
		\textbf{ARIMA (1, 2, 2)} & \textbf{1521.48} & \textbf{39.01} & \textbf{0} \\ \hline
		\textbf{Kalman Filter} & \textbf{1474.82} & \textbf{38.40} & \textbf{0} \\ \hline
	\end{tabular}
...
Upon testing, the Kalman Filter produced a Mean Squared Error (MSE) of 1474.82, Root Mean Squared Error (RMSE) of 38.40 and Mean Absolute Error(MAE) of 22.34.

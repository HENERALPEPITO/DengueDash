...
\begin{itemize}
	...
	\item This gives a refined state estimate that considers both the prediction and measurement based on their relative certainties.
\end{itemize}
...
\begin{itemize}
	...
	\item This updated uncertainty affects the Kalman Gain in the next iteration, reflecting increased confidence in the state estimate after the measurement.
\end{itemize}

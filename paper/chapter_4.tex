...
\begin{table}[h!]
	...
	\resizebox{1\textwidth}{!}{%
		\begin{tabular}{|l|c|c|c|c|}
			\hline
			\textbf{Method} & \textbf{LSTM (Window Size 10)} & \begin{tabular}[c]{@{}c@{}}\textbf{Seasonal ARIMA}\\ \textbf{(2, 0, 2)(0, 1, 1)}\end{tabular} & \textbf{ARIMA (1, 2, 2)} & \textbf{Kalman Filter} \\ \hline
			\textbf{Testing MSE}   & 260.93 & 1109.69 & 1521.48 & 1474.82 \\ \hline
			\textbf{Testing RMSE}  &  16.15  & 33.31  & 39.00 & 38.40 \\ \hline
			\textbf{Testing MAE}   &  9.30  & 18.08  & 25.80 & 22.33 \\ \hline
		\end{tabular}%
	}

...
\begin{document}
	\linenumbers
	\include{title_page}      % includles LaTeX source file for the Title Page 
	\include{abstract}        % includes the Abstract page
	...
	% Place bibliography here so it appears before appendices
	\clearpage
	\bibliographystyle{apacite}  %-- specified APA style for bibliography
	\bibliography{myreferences}  %-- the file "myreferences.bib" contains the bibliography entries
